    ...
    <div className="min-h-screen bg-[#050508] text-white flex items-center justify-center p-4 relative overflow-hidden select-none">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <img
          ...
          className="w-full h-full object-cover filter brightness-[0.15] contrast-[1.05] saturate-[0.1]"
        />
        ...
        <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] rounded-full bg-[#ffd700]/5 filter blur-[120px] animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-red-500/3 filter blur-[120px]" />
      </div>
      ...
      {/* ── AUTHENTICATING DECK CARD ── */}
      <motion.div
        initial={{ opacity: 0, y: 30, scale: 0.98 }}
        animate={{ opacity: 1, y: 0, scale: 1 }}
        transition={{ duration: 0.55, ease: [0.25, 1, 0.5, 1] }}
        className="relative z-10 w-full max-w-md bg-[#0a0a0d]/75 border border-white/10 rounded-[32px] p-8 backdrop-blur-2xl shadow-2xl overflow-hidden mt-8"
        style={{
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-black tracking-tight text-white">
            PILOT <span className="text-white/40 font-light">SIGN IN</span>
          </h2>
          <p className="text-[10px] text-white/30 tracking-wider uppercase mt-1">
            Access your virtual garage and comparative matrix
          </p>
        </div>

        {/* LoginForm render */}
        <LoginForm onSuccessRedirect={from} />
